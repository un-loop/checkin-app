...
const events = new Resource('events', bodyMiddleware, queryMiddleware, require('./resources/events'));
const attendees = new Resource('attendees', bodyMiddleware, queryMiddleware, require('./resources/attendees'));
